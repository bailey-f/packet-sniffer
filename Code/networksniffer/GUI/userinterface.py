    ...
    def addRow(self, packet, packetid):
        ...
        for i in range(0, len(self.headers)):
            ...
            if(self.headers[i] == "Number"):
                self.buttons[i].configure(text=str(packetid))
                self.buttons[i].grid(
...
class ControlFrame(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.filter_subframe1 = Frame(
            self.filter_frame, bg="lightgrey", relief="flat", height=327, width=251, bd=2)
        ...
        self.tcp_butt = Button(self.filter_subframe2, text="TCP", activebackground="lightblue", highlightcolor="lightblue", background="white",
                               borderwidth=2, command=lambda: self.onClick(self.tcp_butt), width=8, height=3, font=("roboto", 18))
        ...
        self.udp_butt = Button(self.filter_subframe2, text="UDP", activebackground="lightblue", highlightcolor="lightblue", background="white",
                               borderwidth=2, command=lambda: self.onClick(self.udp_butt), width=8, height=3, font=("roboto", 18))
        ...
        self.rdp_butt = Button(self.grid_suggested_protocols, text="RDP", activebackground="lightblue", highlightcolor="lightblue", background="white",
                               borderwidth=2, command=lambda: self.onClick(self.rdp_butt), font=("roboto", 12), padx=2, pady=2)
        self.rdp_butt.grid(row=2, column=1, padx=2, pady=2)
        self.onHover(self.rdp_butt)
